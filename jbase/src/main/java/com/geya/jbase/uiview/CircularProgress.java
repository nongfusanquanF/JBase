...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimension(R.styleable.CircularProgress_cpBorderWidth,
                DEFAULT_BORDER_WIDTH * density);
        a.recycle();
        mColors = new int[2];
        mColors[0] = context.getResources().getColor(R.color.app_bg);
        mColors[1] = context.getResources().getColor(R.color.app_theme);
